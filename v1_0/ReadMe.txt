========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : vbbot
========================================================================


Diese vbbot-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\vbbot.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei vbbot.rc eingebunden.
...
vbbotDlg.h, vbbotDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CVbbotDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in vbbot.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	vbbot.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
